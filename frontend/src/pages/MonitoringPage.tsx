          ...
          <div className="flex gap-3">
            ...
            {host && (
              <>
                ...
                <button
                  onClick={handleEdit}
                  className="flex items-center justify-center rounded-lg h-10 px-4 bg-primary text-white text-sm font-bold hover:bg-primary/90 transition-colors gap-2 cursor-pointer active:scale-95"
                >
                ...
                <button
                  ...
                  disabled={isLocal}
                  className="flex items-center justify-center rounded-lg h-10 px-4 bg-red-500 dark:bg-red-600 text-white text-sm font-bold hover:bg-red-600 dark:hover:bg-red-700 transition-colors gap-2 disabled:opacity-50 disabled:cursor-not-allowed active:scale-95"
                >
