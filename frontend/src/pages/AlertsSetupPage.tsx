                  ...
                  >
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <button
                        ...
                        className="px-4 py-2 bg-primary/10 dark:bg-primary/20 text-primary font-bold rounded-lg hover:bg-primary/20 dark:hover:bg-primary/30 transition-all flex items-center gap-2"
                      >
